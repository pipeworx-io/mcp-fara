...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/search_registrants \
  -H 'Content-Type: application/json' \
  -d '{"name":"scoyoc"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/search_registrants`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
